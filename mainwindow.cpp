...
{
    QString fileName = QFileDialog::getOpenFileName(this, tr("O pen flower dataset"), "", tr("CSV file (*.csv)"));
    QFile file(fileName);
...
void MainWindow::on_pb_popularity_clicked(bool checked)
{
    ...
    QRadioButton *rbMaxBegin = new QRadioButton("Popular first",this);
    ...
    QRadioButton *rbMaxEnd = new QRadioButton("Unpopular first", this);
