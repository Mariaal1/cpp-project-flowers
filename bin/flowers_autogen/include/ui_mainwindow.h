...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("../../Pictures/Diamond_Dogs.png"), QSize(), QIcon::Normal, QIcon::Off);
        toolButton->setIcon(icon);
        toolButton_2 = new QToolButton(centralwidget);
        toolButton_2->setObjectName("toolButton_2");
        toolButton_2->setGeometry(QRect(540, 10, 20, 21));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("../../Pictures/reset_6072935.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        if (QIcon::hasThemeIcon(iconThemeName)) {
            ...
            icon2.addFile(QString::fromUtf8("../../Pictures/user_1077063.png"), QSize(), QIcon::Normal, QIcon::Off);
        }
